...
7. Validates response id, seat, impid, price/floor, explicit response currency, approved buyer proof identity, crid, adomain, dealid, media-appropriate VAST/display/native `adm`, VAST MIME/duration/dimension constraints, and notice/proof fields.
